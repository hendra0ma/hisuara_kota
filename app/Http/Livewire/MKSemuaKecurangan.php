...
class MKSemuaKecurangan extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $data['jumlah_semua_kecurangan']  = Tps::join('saksi', 'saksi.tps_id', '=', 'tps.id')
        ...
        return view('livewire.m-k-semua-kecurangan', $data);
    }
}
