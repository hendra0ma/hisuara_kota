                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="number" class="form-control" id="inputname1" readonly=""
                                                    value="{{$saksi_data->voice}}" name="suara[]" placeholder="Suara 01">
                                            </div>
                                            @endforeach
                                            @endforeach
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('verifikator.actionKoreksiData',Crypt::encrypt($id))}}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label>Suara 0{{$i}}</label>
                                                        <input type="number" class="form-control suara-input" id="suara[]" name="suara[]"
                                                            required placeholder="Total Suara 0{{$i}}">
                                                    </div>
                                                    <?php $i++ ?>
                                                    @endforeach
                                                    @endforeach
                                        ...
                                        <small>
                                            Perubahan data yang saya lakukan sesuai dengan data C1. Saya menyatakan tunduk dan
                                            patuh terhadap Undang-Undang Pemilu yang berlaku dan siap mempertanggung jawabkan
                                            perubahan data ini.
                                        </small>
                                        <div class="custom-control custom-checkbox mt-2 mb-1">
                                            <input type="checkbox" required="" class="custom-control-input" id="customCheck2"
                                                name="persetujuan" data-parsley-multiple="groups" data-parsley-mincheck="2">
