<div class="col-lg-6" style="height: 100vh; overflow: scroll">
    <center>
        <img src="{{asset('storage'.'/c1_plano/'.$relawan->c1_images)}}" data-magnify-speed="200" alt="" data-magnify-magnifiedwidth="1500" data-magnify-magnifiedheight="1500" class="img-fluid zoom" data-magnify-src="{{asset('storage'.'/c1_plano/'.$relawan->c1_images)}}">
    </center>
</div>
...
<div class="col-lg-6" style="height: 100vh; overflow: scroll">
    ...
    $user = App\Models\User::where('id', $relawan->relawan_id)->first();
