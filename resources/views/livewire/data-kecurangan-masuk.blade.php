                    ...
                    <div class="px-3">
                        ...
                        <div class="row mt-2">
                            <div class="col-12 px-0">
                                <button class="btn rounded-0 w-100 fotoKecurangan mt-2 rounded-0 text-white" id="Cek" data-bs-toggle="modal" id="" data-bs-target="#fotoKecurangan" data-id="{{$ls->tps_id}}" style="background-color: #ff4f4e;">Validasi Kecurangan</button>
                            </div>
                        </div>
                    </div>
                </div>
