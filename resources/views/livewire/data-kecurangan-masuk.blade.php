<div>
    ...
    Jumlah Data Kecurangan Masuk : {{$jumlah_data_kecurangan_masuk}}
    </h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md">
                            ...
                            <img class="" style="width: 250px; height: 250px; object-fit:cover" src="https://ui-avatars.com/api/?name={{ $ls->name }}&color=7F9CF5&background=EBF4FF" alt="img">
                            @else
                        ...
                        <div class="col-md">
                            ...
                            <div class="row mb-2">
                                <div class="col-md fw-bold">
                                    <a href="fotomasalah" style="background-color: #ff4f4e" class="btn w-100 fotoKecurangan mt-2 rounded-0 text-white" id="Cek" data-bs-toggle="modal" id="" data-bs-target="#fotoKecurangan" data-id="{{$ls->tps_id}}">
