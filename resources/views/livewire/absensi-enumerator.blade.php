        ...
        <div class="col-lg-12">
            <div class="card border-0" style="position: relative">
                ...
                <div style="position: relative;"
                    class="card-header bg-primary text-light text-center fw-bold rounded-0">
                    <span style="position: absolute; left: 15px" class="fw-normal">1/2</span> Foto dan Kirim Absensi
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="px-0 col-12 text-center mb-3">
                            ...
                            @else
                            <img class="rounded-circle"
                                style="width: 100px; height: 100px; object-fit: cover; margin-right: 10px;" src="{{url("/storage/profile-photos/".Auth::user()->profile_photo_path) }}">
                            @endif
                        </div>
                    ...
                    <form action="{{route('actionAbsensiSaksi')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row no-gutters mt-2">
                                ...
                                <div class="card" style="height:30vh">
                                    ...
                                    <div class="card-body d-flex">
                                        <div class="row my-auto mx-auto">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <input type="file" name="selfie_lokasi" style="width: 205px;" required
                                                    id="selfie_lokasi">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-grid gap-2">
                                <input type="submit" name="" class="btn btn-block btn-primary mt-2" value="Kirim"
                                    id="send">
                            </div>
                        </div>
                    </form>
