<div style="overflow-y:auto; overflow-x: hidden">
    ...
    <div class="container">
        <p style="text-align: justify">Laporan Kecurangan Pemilu ini terintegrasi dengan sistem laporan kecurangan pada
            ...
            Hisuara.</p>
        <p style="text-align: justify">Setiap saksi yang melaporkan kecurangan juga akan terintegrasi langsung dengan sidang
            online
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-12 col-sm-12 mb-4 mb-lg-0">
                                <div class="dropify-wrapper">
                                    ...
                                    <div class="dropify-errors-container">
                                        <ul></ul>
                                    </div><input type="file" class="dropify" data-bs-height="180" name="foto[]"
                                        multiple><button type="button" class="dropify-clear">Remove</button>
                            ...
                            <div class="col-lg-12 col-sm-12 mb-4 mb-lg-0">
                                <div class="dropify-wrapper">
                                    ...
                                    <div class="dropify-errors-container">
                                        <ul></ul>
                                    </div><input type="file" class="dropify" name="video[]" multiple
                            ...
                            <thead>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="curang[]"
                                            value=" {{ $item['kecurangan'] }}|{{$item['jenis']}}"
