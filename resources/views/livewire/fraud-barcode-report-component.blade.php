<div class="row">
    ...
    <div class="col-md-6">
        <center>
            <div class="card" onclick="window.location.href = '{{$scan_url}}'" style="background-color:white; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="px-0 col-3 text-center mb-3">
                            ...
                            @else
                            <img style="width: 150px; height: 150px; object-fit: cover; margin-right: 10px;" src="{{url("/storage/profile-photos/".$item['profile_photo_path']) }}">
                            @endif
                        </div>
