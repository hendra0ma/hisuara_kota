<div>
    ...
    <div class="row">
        ...
        $village = App\Models\Village::where('id',$ls->village_id)->first();
        $district = App\Models\District::where('id',$ls->district_id)->first();
                    ...
                    <div class="px-3">
                        ...
                        <div class="row mt-2">
                            <div class="col-12 px-0">
                                <button class="btn text-white rounded-0 w-100 periksa-c1-crowd" style="background-color: rgb(251, 107, 37)" id="Cek" data-id="{{$ls->crowd_id}}"
                                    data-bs-toggle="modal" id="" data-bs-target="#periksaC1Relawan"onclick="periksac1Crowds(`{{$ls->crowd_id}}`)">Verifikasi Kiriman C1</button>
                            </div>
                        </div>
                    </div>
                </div>
