    ...
    <div class="page-main">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="side-menu">
                ...
                <li>
                    <a class="side-menu__item modal-action" href="{{url('')}}/huver/verifikasi_saksi">
                        <i class="side-menu__icon mdi mdi-home"></i><span class="side-menu__label">Otentifikasi Saksi</span></a>
                </li>
                <li>
                    <a class="side-menu__item modal-action" href="{{url('')}}/huver/verifikasi_akun">
                        <i class="side-menu__icon mdi mdi-home"></i><span class="side-menu__label">Otentifikasi Admin</span></a>
                </li>
                <li>
                    <a class="side-menu__item modal-action" href="{{url('')}}/huver/verifikasi_koreksi">
