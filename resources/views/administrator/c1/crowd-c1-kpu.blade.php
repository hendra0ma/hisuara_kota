...
<div class="row">
    <div class="col">
        <h4 class="fw-bold fs-4 mt-5 mb-0">
            Jumlah Operator Crowd C1 KPU : {{$jumlah_c1}}
        </h4>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verify-crowd-c1Label"><img style="height: 50px;" class="mb-3 me-3"
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/KPU_Logo.svg/531px-KPU_Logo.svg.png" alt=""> Verifikasi Crowd C1 KPU</h5>
