...
<div class="row mt-5">
    <div class="col-lg">
        <h1 class="page-title fs-1 mt-2">Kordinator Saksi RW
            <!-- Kota -->
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row mt-2">
            ...
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_saksi"
                    class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/koordinator_saksi')?'active' : '' }}">Kordinator Saksi Kota</a>
            </div>
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_kecamatan"
                    class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/koordinator_kecamatan')?'active' : '' }}">Kordinator Saksi Kecamatan</a>
            </div>
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_kelurahan"
                    class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/koordinator_kelurahan')?'active' : '' }}">Kordinator Saksi Kelurahan</a>
            </div>
            <div class="col parent-link">
            ...
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_rt"
                    class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/koordinator_rt')?'active' : '' }}">Kordinator Saksi RW</a>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom table-hover w-100"
                            id="basic-datatable">
