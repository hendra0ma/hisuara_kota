...
<div class="row mt-5">
    <div class="col-lg">
        <h1 class="page-title fs-1 mt-2">Koordinator Kecamatan
            <!-- Kota -->
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row mt-2">
            ...
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_saksi"
                    class="btn text-white w-100 py-3 btn-to-loader {{ (url()->current() == url('').'/administrator/koordinator_saksi')?'active' : '' }}">Koordinator Saksi
                    Kota</a>
            </div>
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_kecamatan"
                    class="btn text-white w-100 py-3 btn-to-loader {{ (url()->current() == url('').'/administrator/koordinator_kecamatan')?'active' : '' }}">Koordinator Saksi
                    Kecamatan</a>
            </div>
            <div class="col parent-link">
                <a href="{{url('')}}/administrator/koordinator_kelurahan"
                    class="btn text-white w-100 py-3 btn-to-loader {{ (url()->current() == url('').'/administrator/koordinator_kelurahan')?'active' : '' }}">Koordinator Saksi
                    Kelurahan</a>
            </div>
