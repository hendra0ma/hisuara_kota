...
<div class="row">
    <div class="col-lg" style="position: fixed; z-index: 10; background: #f2f3f9">
        <h1 class="page-title fs-1 mt-2">Verifikasi Pendaftaran Saksi
            <!-- Kota -->
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-8" style="position: fixed; right: 21px; width: 1244.66px; z-index: 10; background: #f2f3f9">
        <div class="row mt-2">

            {{-- <div class="col parent-link">
                <a data-command-target="verifikasi-saksi" href="{{url('')}}/administrator/verifikasi_saksi" class="btn text-white w-100 py-3">Verifikasi Saksi</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-teregistrasi" href="{{url('')}}/administrator/absensi" class="btn text-white w-100 py-3">Saksi Teregristrasi</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-hadir" href="{{url('')}}/administrator/absensi/hadir" class="btn text-white w-100 py-3">Saksi Hadir</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-tidak-hadir" href="{{url('')}}/administrator/absensi/tidak_hadir" class="btn text-white w-100 py-3">Saksi Tidak Hadir</a>
        </div> --}}
        <div class="col parent-link">
            <a data-command-target="verifikasi-saksi" href="{{url('')}}/administrator/verifikasi_saksi" class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/verifikasi_saksi')?'active' : '' }}">Verifikasi Saksi</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-teregistrasi" href="{{url('')}}/administrator/absensi" class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/absensi')?'active' : '' }}">Saksi Teregistrasi</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-hadir" href="{{url('')}}/administrator/absensi/hadir" class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/absensi/hadir')?'active' : '' }}">Saksi Hadir</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-tidak-hadir" href="{{url('')}}/administrator/absensi/tidak_hadir" class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/absensi/tidak_hadir')?'active' : '' }}">Saksi Tidak Hadir</a>
        </div>
        <div class="col parent-link">
            <a data-command-target="saksi-ditolak" href="{{url('')}}/administrator/saksi_ditolak" class="btn text-white w-100 py-3 {{ (url()->current() == url('').'/administrator/absensi/saksi_ditolak')?'active' : '' }}">Saksi Ditolak</a>
        </div>
...
<div style="position: fixed; width: 97%; margin-top: 76px; z-index: 10; background: #f2f3f9">
    <div class="row">
        ...
        <div class="col-md-auto mt-auto">
            <div class="ms-auto">
                <button style="width: 82.22px; height: 38px" class="btn btn-success my-auto">
