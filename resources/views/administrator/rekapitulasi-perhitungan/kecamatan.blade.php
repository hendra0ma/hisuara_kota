...
<div class="row" style="margin-top: 90px; transition: all 0.5s ease-in-out;">
    ...
    <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{url('')}}/administrator/rekap_kecamatan/{{Crypt::encrypt($id_kecamatan)}}"
                        ...
                        <table class="table table-bordered table-hover mt-3">
                            ...
                            <tbody>
                                ...
                                <tr onclick='check("{{Crypt::encrypt($item->id)}}")'>
                                    <td class="align-middle"><a
                                            href="{{url('/')}}/administrator/rekap_kelurahan/{{Crypt::encrypt($item['id'])}}">{{$item['name']}}</a>
                                    </td>
                                    @foreach ($paslon as $cd)
                            ...
                            <script>
                                let check = function (id) {
                                    window.location = `{{url('/')}}/administrator/rekap_kelurahan/${id}`;
                                }
                            </script>
                        </table>
                    </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="card-title mx-auto">
                        <a href="{{url('/')}}/administrator/rekap_kelurahan/{{Crypt::encrypt($item['id'])}}">
                            KELURAHAN {{$item['name']}}
                        </a>
                    </div>
                </div>
