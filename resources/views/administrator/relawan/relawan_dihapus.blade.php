...
<div class="row mt-5">
    <div class="col-lg" style="position: fixed; z-index: 10; background: #f2f3f9">
        <h1 class="page-title fs-1 mt-2">Relawan TPS Dihapus
            <!-- Kota -->
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-4" style="position: fixed; right: 18px; width: 1244.66px; z-index: 10; background: #f2f3f9">
        <div class="row mt-2">
            ...
            <div class="col parent-link">
                <a data-command-target="relawan-terdaftar" href="{{url('')}}/administrator/relawan"
                    class="btn text-white w-100 py-3 btn-to-loader {{ (url()->current() == url('').'/administrator/relawan')?'active' : '' }}">Relawan
                    Terdaftar</a>
            </div>
            <div class="col parent-link">
                <a data-command-target="relawan-dihapus" href="{{url('')}}/administrator/relawan_dihapus"
                    class="btn text-white w-100 py-3 btn-to-loader {{ (url()->current() == url('').'/administrator/relawan_dihapus')?'active' : '' }}">Relawan
                    Dihapus</a>
            </div>
...
<script>
    $(document).ready(function() {
        var specificUrl = "{{ url('') }}/administrator/relawan"; // Specific URL to match
