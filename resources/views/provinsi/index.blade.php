                                                    ...
                                                    <div class="col-12">
                                                        <div class="mx-auto counter-icon box-shadow-secondary brround candidate-name text-white "
                                                            ...
                                                            <img style="bottom: -10px; position: absolute; left: 50%; transform: translateX(-50%);"
                                                                src="{{ asset('') }}storage/{{ $pas->picture }}"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col text-center">
                                                        <h6 class="mt-4">{{ $pas->candidate }} -
                                                            {{ $pas->deputy_candidate }}</h6>
                                                        @php
                                                            $voice = 0;
                        ...
                        <div class="col-xxl-6">
                            ...
                            <table class="table table-bordered table-hover mt-3 tabel-kustom">
                                <thead class="bg-primary">
                                    <tr>
                                        <th class="text-white text-center align-middle">Kota/Kabupaten</th>
                    ...
                    @foreach ($regencies as $item)
                        <div class="col-auto my-2">
                            <div class="text-center mb-2">
                                <img src="{{ asset('assets/imagesKota/' . $item->logo_kota) }}" style="height: 120px"
                                    alt="">
                            </div>
