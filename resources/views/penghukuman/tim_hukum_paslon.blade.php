...
<div class="row mt-5 mb-5" style="padding-left: 13px; padding-right: 13px">
    ...
    <hr>
    <h2 style="border-bottom: 2px solid" class="px-0 pb-3 fw-bold mb-0 tugel mt-3" data-bs-toggle="collapse" href="#collapse2" role="button" aria-expanded="false"
    ...
    <hr>
    <h2 style="border-bottom: 2px solid" class="px-0 pb-3 fw-bold mb-0 tugel mt-3" data-bs-toggle="collapse" href="#collapse3" role="button" aria-expanded="false"
        aria-controls="multiCollapseExample2">
        <div class="row">
            <div class="col-6">
                Data 3
    ...
    <hr>
    <h2 style="border-bottom: 2px solid" class="px-0 pb-3 fw-bold mb-0 tugel mt-3" data-bs-toggle="collapse" href="#collapse4" role="button" aria-expanded="false"
        aria-controls="multiCollapseExample2">
        <div class="row">
            <div class="col-6">
                Data 4
    ...
    <hr>
    <h2 style="border-bottom: 2px solid" class="px-0 pb-3 fw-bold mb-0 tugel mt-3" data-bs-toggle="collapse" href="#collapse5" role="button" aria-expanded="false"
        aria-controls="multiCollapseExample2">
        <div class="row">
            <div class="col-6">
                Data 5
    ...
    <div class="row collapse multi-collapse chevron-logic" id="collapse5">
        <div class="col-12 px-0">
            <h2 class="fw-bold mt-5">
                Peserta Sidang MK
            </h2>
